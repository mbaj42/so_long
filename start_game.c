...
/*   Updated: 2024/08/12 02:10:31 by mbaj             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	game->txt.c = mlx_xpm_to_image(game->mlx, "textures/texturesC.xpm",
			&(game->w), &(game->h));
	game->txt.z = mlx_xpm_to_image(game->mlx, "textures/textures0.xpm",
			&(game->w), &(game->h));
	game->txt.w = mlx_xpm_to_image(game->mlx, "textures/textures1.xpm",
			&(game->w), &(game->h));
	game->txt.e = mlx_xpm_to_image(game->mlx, "textures/texturesE.xpm",
			&(game->w), &(game->h));
	game->txt.p = mlx_xpm_to_image(game->mlx, "textures/texturesP.xpm",
			&(game->w), &(game->h));
}
